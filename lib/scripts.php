...
function my_scripts() {
	// CSS first
	if ( !is_admin() ) {
		wp_enqueue_style( 'style', get_stylesheet_directory_uri().'/style.css', null, '1.7', 'all' );
	...
	if ( !is_admin() ) {
		wp_enqueue_script( 'customplugins', get_template_directory_uri() . '/assets/js/plugins.min.js?v=1.0', array('jquery'), NULL, true );
		wp_enqueue_script( 'customscripts', get_template_directory_uri() . '/assets/js/main.min.js?v=1.0', array('jquery'), NULL, true );
